...
import com.tlv.vincles.tlvincles.Client.Requests.GetNotificationsRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetServerTimeRequest;
import com.tlv.vincles.tlvincles.Client.Requests.RenewTokenRequest;
...
public class NotificationsManager extends Service implements GetNotificationsRequest.OnResponse,
    ...
    public void onCreate() {
        ...
        new com.tlv.vincles.tlvincles.Client.Environment.Environment(this.getApplicationContext());
