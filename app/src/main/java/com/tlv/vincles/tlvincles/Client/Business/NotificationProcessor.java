...
import com.tlv.vincles.tlvincles.Client.Db.UserMessageDb;
import com.tlv.vincles.tlvincles.Client.Db.UsersDb;
import com.tlv.vincles.tlvincles.Client.Errors.VinclesError;
import com.tlv.vincles.tlvincles.Client.Model.ChatMessageRest;
import com.tlv.vincles.tlvincles.Client.Model.CircleUser;
import com.tlv.vincles.tlvincles.Client.Model.Db.GroupMessageDb;
...
import com.tlv.vincles.tlvincles.Client.Model.Db.Model.UserGroupsDb;
import com.tlv.vincles.tlvincles.Client.Model.Dynamizer;
import com.tlv.vincles.tlvincles.Client.Model.GetUser;
import com.tlv.vincles.tlvincles.Client.Model.GroupMessageRest;
import com.tlv.vincles.tlvincles.Client.Model.GuestRest;
import com.tlv.vincles.tlvincles.Client.Model.MeetingRealm;
import com.tlv.vincles.tlvincles.Client.Model.MeetingRest;
import com.tlv.vincles.tlvincles.Client.Model.UserGroup;
...
import com.tlv.vincles.tlvincles.Client.Requests.GetCircleUserRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetContentInMyGallery;
import com.tlv.vincles.tlvincles.Client.Requests.GetGroupMessageRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetGroupMessagesRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetGroupUserListRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetMeetingRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetMessageRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetPublicUserDataRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetServerTimeRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetUserDataRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetUserGroupsRequest;
import com.tlv.vincles.tlvincles.R;
import com.tlv.vincles.tlvincles.UI.Calls.CallsActivity;
import com.tlv.vincles.tlvincles.UI.Calls.CallsActivityView;
import com.tlv.vincles.tlvincles.UI.FragmentManager.MainFragmentManagerActivity;
import com.tlv.vincles.tlvincles.Utils.DateUtils;
import com.tlv.vincles.tlvincles.Utils.MyApplication;
import com.tlv.vincles.tlvincles.Utils.OtherUtils;
import com.tlv.vincles.tlvincles.Utils.RequestsUtils;
...
public class NotificationProcessor implements GetMessageRequest.OnResponse, GetGroupMessageRequest.OnResponse, GetUserDataRequest.OnResponse,
    ...
    void processNotification() {
        switch (type) {
            ...
            case "USER_UNLINKED":
            case "USER_LEFT_CIRCLE":
                UsersDb usersDb = new UsersDb(getAppContext());
            ...
            case "NEW_USER_GROUP":
                ...
                break;
            case "REMOVED_FROM_GROUP":
                UserGroupsDb userGroupsDb = new UserGroupsDb(getAppContext());
                ...
                break;
            case "REMOVED_USER_GROUP":
                userGroupsDb = new UserGroupsDb(getAppContext());
    ...
    public void onResponseGetMessageRequest(ChatMessageRest chatMessageRest) {
        ...
        new UserMessageDb(getAppContext()).saveChatMessageRest(chatMessageRest);
        ...
        UserMessageDb userMessageDb = new UserMessageDb(getAppContext());
        usersDb.setMessagesInfo(userId, userMessageDb.getNumberUnreadMessagesReceived(idMe, userId),
                new NotificationsDb(getAppContext())
    ...
    public void onResponseGetContentInMyGallery(GalleryContentRealm galleryContent) {
        ...
        if(!galleryContent.getMimeType().equals("audio/aac") && !galleryContent.getMimeType().equals("audio/mp3") ){
          GalleryDb galleryDb = new GalleryDb(getAppContext());
    ...
    public void onResponseGetGroupMessageRequest(GroupMessageRest groupMessageRest) {
        ...
        new GroupMessageDb(getAppContext()).saveGroupMessageRest(groupMessageRest);
        Bundle data = new Bundle();
        data.putString("type", type);
    ...
    public void onResponseGetCircleUserRequest(ArrayList<CircleUser> circleUsers) {
        ...
        new UsersDb(getAppContext()).saveCircleUsers(circleUsers);
        Bundle data = new Bundle();
        data.putString("type", type);
        onNotificationProcessed(data);
    }
    ...
    public void onResponseGetGroupMessagesRequest(ArrayList<GroupMessageRest> groupMessageRestList, String idChat) {
       ...
       // List<GroupMessageRest> messages = groupMessageRestList.getChatMessageRestList();
        if (groupMessageRestList != null && groupMessageRestList.size() > 0) {
            GroupMessageDb groupMessageDb = new GroupMessageDb(getAppContext());
    ...
    private void processDeleteMeeting() {
        MeetingsDb meetingsDb = new MeetingsDb(getAppContext());
        ...
        Log.d("incalock","notiProcessor processincomingcall()");
            ...
            GetUser getUser = usersDb.findUserUnmanaged(idUser);
             ...
             if (getUser != null) {
                ...
                Intent intent = new Intent(getAppContext(), CallsActivity.class);
                Bundle bundle = new Bundle();
                ...
                Log.d("callvid","context " +  String.valueOf(getAppContext()));
    ...
    private void processMissedCall() {
        ...
        if (usersDb.findUserUnmanaged(idUser) != null) {
            ...
            new NotificationsDb(getAppContext()).saveMissedCallNotification(
                    notificationTime, idUser);
            new UsersDb(getAppContext()).setMessagesInfo(idUser,
                    new UserMessageDb(getAppContext())
                            .getNumberUnreadMessagesReceived(new UserPreferences().getUserID(),
                                    idUser),
                    new NotificationsDb(getAppContext())
                            .getNumberUnreadMissedCallNotifications(idUser),
                    Math.max(new UserMessageDb(getAppContext()).getLastMessage(
    ...
    public void onResponseGetMeetingRequest(MeetingRest meetingRest) {
        ...
        new MeetingsDb(getAppContext()).saveMeetingRest(meetingRest,
                userPreferences.getIsSyncCalendars() ? userPreferences.getCalendarId() : -1);
    ...
    private static void showNotification(String type, String channelId, String channelName,
        ...
        if (type.equals("NEW_MESSAGE") || type.equals("NEW_CHAT_MESSAGE")) {
            ...
            notificationId = new UserPreferences(getAppContext())
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(
                getAppContext(), notificationId, intent, 0);
    ...
    private String getGroupName() {
        ...
        UserGroupsDb db = new UserGroupsDb(getAppContext());
    ...
    private long getMeetingDate() {
        return new MeetingsDb(getAppContext()).findMeeting(idMeeting).getDate();
    }
