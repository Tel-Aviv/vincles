package com.tlv.vincles.tlvincles.UI.FragmentManager;
...
import com.tlv.vincles.tlvincles.Client.Model.ChatMessageMulticastRest;
import com.tlv.vincles.tlvincles.Client.Model.ChatMessageRest;
import com.tlv.vincles.tlvincles.Client.Model.ChatMessageSentResponse;
import com.tlv.vincles.tlvincles.Client.Model.ChatMessagesSentResponse;
...
import com.tlv.vincles.tlvincles.Client.Requests.AddUserRequest;
import com.tlv.vincles.tlvincles.Client.Requests.BaseRequest;
import com.tlv.vincles.tlvincles.Client.Requests.DeleteCircleRequest;
import com.tlv.vincles.tlvincles.Client.Requests.ExitCircleRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GenerateUserCodeRequest;
...
import com.tlv.vincles.tlvincles.Client.Requests.GetGroupPhotoRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetMessageRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetUserCircleRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetUserGroupsRequest;
import com.tlv.vincles.tlvincles.Client.Requests.GetUserPhotoRequest;
import com.tlv.vincles.tlvincles.Client.Requests.SendMessageMulticastRequest;
import com.tlv.vincles.tlvincles.Client.Requests.SendMessageRequest;
import com.tlv.vincles.tlvincles.UI.Contracts.Contact;
import com.tlv.vincles.tlvincles.UI.Contracts.ContactsPresenterContract;
...
import static com.tlv.vincles.tlvincles.UI.Contracts.Contact.TYPE_CIRCLE_USER;
import static com.tlv.vincles.tlvincles.UI.Contracts.Contact.TYPE_USER_CIRCLE;
import static com.tlv.vincles.tlvincles.UI.Contracts.ContactsPresenterContract.FILTER_ALL_CONTACTS;
import static com.tlv.vincles.tlvincles.Utils.OtherUtils.convertIntegers;
    ...
    public void onFinishedLoadingContacts(boolean local) {
        ...
        if ((allCircleUsersList.size() + familyContactsList.size() + groupsList.size() + dynamizersList.size()) != contactsListSize || local) {
            ...
            if (allCircleUsersList != null && (
                    (filterKind == FILTER_ALL_CONTACTS)
