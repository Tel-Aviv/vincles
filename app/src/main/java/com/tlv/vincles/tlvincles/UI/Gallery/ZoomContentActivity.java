...
public class ZoomContentActivity extends BaseActivity implements Player.EventListener,
        StyledPlayerControlView.VisibilityListener,
        OnViewTapListener, View.OnClickListener {
    ...
    private void setupExoPlayer(Context context, boolean isOnResume) {
        if (exoPlayer == null) {
            exoPlayer = new SimpleExoPlayer.Builder(this).build(); //ExoPlayerFactory.newSimpleInstance(context, new DefaultTrackSelector());
        ...
        if (isOnResume) {
            ...
            // ok exoPlayerView.setControllerVisibilityListener(this);
        }
    }
